...
import { getLanguageShares } from "@/lib/github";
...
export default function RepositoryExplorer() {
  ...
  // Primary language comes from the real public repository mix on GitHub.
  const primaryLanguage = useMemo(() => getLanguageShares(githubRepos)[0]?.name ?? "Kotlin", [githubRepos]);
